...
class Ui_CalculatorForm(object):
    def setupUi(self, CalculatorForm):
        ...
        sizePolicy = QSizePolicy(QSizePolicy.Policy(5), QSizePolicy.Policy(5))
        ...
        self.gridlayout = QGridLayout(CalculatorForm)
        self.gridlayout.setContentsMargins(9, 9, 9, 9)
        self.gridlayout.setSpacing(6)
        self.gridlayout.setObjectName("gridlayout")
        spacerItem = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)
        self.gridlayout.addItem(spacerItem, 0, 6, 1, 1)
        self.label_3_2 = QLabel(CalculatorForm)
        ...
        self.label_2_2_2 = QLabel(CalculatorForm)
        ...
        self.outputWidget = QLabel(CalculatorForm)
        self.outputWidget.setGeometry(QtCore.QRect(1, 24, 36, 27))
        self.outputWidget.setFrameShape(QFrame.Box)
        self.outputWidget.setFrameShadow(QFrame.Sunken)
        ...
        self.label_2 = QLabel(CalculatorForm)
        self.label_2.setGeometry(QtCore.QRect(1, 1, 46, 19))
        self.label_2.setObjectName("label_2")
        self.vboxlayout1.addWidget(self.label_2)
        self.inputSpinBox2 = QSpinBox(CalculatorForm)
        ...
        self.label_3 = QLabel(CalculatorForm)
    ...
    def retranslateUi(self, CalculatorForm):
        pass
        # CalculatorForm.setWindowTitle(QApplication.translate("CalculatorForm", "Calculator Form", None, QApplication.UnicodeUTF8))
        # self.label_3_2.setText(QApplication.translate("CalculatorForm", "=", None, QApplication.UnicodeUTF8))
        # self.label_2_2_2.setText(QApplication.translate("CalculatorForm", "Output", None, QApplication.UnicodeUTF8))
        # self.outputWidget.setText(QApplication.translate("CalculatorForm", "0", None, QApplication.UnicodeUTF8))
        # self.label_2.setText(QApplication.translate("CalculatorForm", "Input 2", None, QApplication.UnicodeUTF8))
        # self.label_3.setText(QApplication.translate("CalculatorForm", "+", None, QApplication.UnicodeUTF8))
        # self.label.setText(QApplication.translate("CalculatorForm", "Input 1", None, QApplication.UnicodeUTF8))
